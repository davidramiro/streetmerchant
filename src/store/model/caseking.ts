...
export const Caseking: Store = {
  ...
  labels: {
    inStock: [
      ...
      {
        container: '.product-availability-message .text-truncate',
        text: ['auf lager'],
      },
    ],
    maxPrice: 
  ...
  links: [
    ...
    },
    {
      ...
      model: 'ventus 3x oc',
      series: '5080',
      url: 'https://www.caseking.de/msi-geforce-rtx-5080-16g-ventus-3x-oc-white-16384-mb-gddr7/GCMC-397.html',
    },
    {
      brand: 'inno3d',
      model: 'ichill frostbite',
